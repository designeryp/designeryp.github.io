...
u.prototype = {g: function() {
        ...
        var a = document.querySelectorAll("figure > img"), b = document.getElementsByClassName("inline-graphic");
...
History.prototype = {g: function() {
        ...
        var a = null, b = document.querySelectorAll(".svg-container");
...
function y(a, b, c) {
    ...
    e.onreadystatechange = function() {
        if (4 === e.readyState) {
            var f = e.responseText, g = document.createElement("div");
            g.innerHTML = f;
            B(a, g.getElementsByTagName("article")[0].innerHTML);
            var f = document.getElementsByTagName("article")[0], k = document.getElementsByTagName("title")[0];
            A(k, g, null);
            g = {};
            g.K = f.innerHTML;
            ...
            var r = null, l = null;
            if (null === b.getAttribute("data-id") || void 0 === b.getAttribute("data-id"))
                historian.j = void 0, nav_parts.close();
...
function z(a, b) {
    if (historian.k) {
        ...
        var c = b.parentElement.classList.contains("next-link"), e = b.parentElement.classList.contains("previous-link");
  ...
  c.push(a.firstChild)
      ...
      A(a, null, historian.$);
            ...
            if (a = document.getElementsByClassName("nav-chapter-active")[0])
                a.classList.remove("nav-chapter-active"), a.parentElement.classList.remove("nav-current-chapter");
            F()
        }
    }
};
...
Navigator.prototype = {g: function() {
        ...
        this.i && null !==
                this.i.parentElement && this.i.parentElement.classList.remove("nav-part-active")
    }, S: function(a) {
        var b = a.target, c = void 0;
        if ("LI" === b.nodeName)
            "A" === b.firstChild.nodeName && (c = b.firstChild);
        else if ("A" === b.nodeName && !1 === b.parentElement.classList.contains("part-name"))
            return;
        if (void 0 !== c && !0 === b.classList.contains("nav-part-active"))
            z(c, c);
        else {
...
function F() {
    var a = nav_parts, b = document.getElementsByTagName("article")[0].getElementsByTagName("a")[1].getAttribute("name");
...
function H(a) {
    ...
    this.b = h(a);
    this.e = !1;
    this.a = {filter: this.b.c(".filter"), h: this.b.l(".item a"), matches: this.b.c("#filter_matches")};
    this.ja = [];
    this.index = -1;
...
RegExp("^\\+( )?" + a.substring(1), "i");
          ...
          g.test(e) ? L(f, g, e) : f.classList.add("hidden")
            ...
            if (0 > this.index)
                ...
                this.a.filter.blur();
                var a = O(), a = this.b.l(a + ".item:not(.hidden) a:not(.hidden)")[this.index];
  ...
  this.b.classList.add("closing"), this.e = !1)
    ...
    function da(a, b) {
        this.R = b;
        this.data = {};
        this.a = {L: h(".chapter"), f: {language: h("#language"), deployment_target: h("#deployment_target_" + b), deprecated: h("#deprecated"), auto_expand: h("#auto_expand")}, h: m(".symbol"), ha: m(".task-group"), ta: m(".task-group-section"), Ea: m(".nav-parts .tasks .nav-chapter")};
        this.D = !1;
        this.ka = null;
        this.J = {V: -1 < navigator.userAgent.indexOf("Xcode/"), qa: -1 < navigator.userAgent.indexOf("iPad")}
    }
    ...
    function P(a, b) {
        ...
        if (c) {
            var e = n(c, ".symbol"), f = h("a").title, g = "";
            if (e)
                Q(a, e, !1), R(a, e).e || S(a, e), c = c.parentNode.l("a[href]"), c[0].getClientRects()[0] ? g = c[0].textContent + " - " : c[1].getClientRects()[0] && (g = c[1].textContent + " - "), document.title = g + f;
            else if (e = n(c, ".task-group"))
                Q(a, e, !1), g = c.parentNode.c(".section-name").textContent, document.title = g + " - " + f
        }
    }
    function ma() {
        var a = ref;
    ...
    function na() {
        var a = ref, b = h(".overview-bulk"), c = h(".overview-bulk-toggle");
    ...
    function ha() {
        ...
        var b = h(".tasks"), c = m(".tasks .nav-chapter a"), e = [];
  ...
  g++
      ...
      e.join(",<br />")
        ...
        a.forEach(function(a) {
            ...
            for (var c = a.l(".nl"), e = 0, e = "", f = 1; f < c.length; f++)
  ...
  e.q === b ? f || (f = document.createElement("span"), f.className = "new", f.innerHTML = "(New in " + ("mac" === this.R ? "OS X" : "iOS") + " " + ("mac" === this.R ? "v10." : "") + b + ")", a.c(".task-group-term").appendChild(f)) : f && a.c(".task-group-term").removeChild(f)
    ...
    function U(a, b) {
        var c = R(a, b), e = b.offsetTop, f = c.y, g = 20;
        c.I && (g = R(a, c.I).y);
    ...
    function wa(a, b, c) {
        var e = R(a, b).I, f = n(e, ".task-group-section");
  ...
  R(this, q).y = s
        ...
        h(".last-one").classList.contains("fat") ||
                (h(".last-one").classList.add("fat"), c += 750);
        T(a, c)
    }
    function S(a, b) {
        var c = R(a, b), e = c.p;
    ...
    function ka() {
        var a = h(".nav-parts .part-name.tasks"), b = window.innerHeight - 70 - 32 - (h(".nav-parts").clientHeight - a.clientHeight), b = Math.max(b, 61);
        a.style.maxHeight = b + "px"
    }
    function Da() {
        var a = ref, b = 0;
        a.a.h.forEach(function(a) {
            var e = new Ea(a), f = "s" + b++;
            e.g(f);
            this.data[f] = e;
